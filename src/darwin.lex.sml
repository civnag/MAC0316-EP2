        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction6(strm, yyNO_MATCH)
                      else yyQ25(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction6(strm, yyNO_MATCH)
                  else yyQ25(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
            else if inp = 0wx74
              then yyQ53(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
            else if inp < 0wx74
              then if inp <= 0wx60
                  then yyAction6(strm, yyNO_MATCH)
                  else yyQ25(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
       ...
       of NONE => yyAction8(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then yyQ80(strm', yyMATCH(strm, yyAction8, yyNO_MATCH))
            else if inp < 0wx64
              then if inp <= 0wx60
                  then yyAction8(strm, yyNO_MATCH)
                  else yyQ25(strm', yyMATCH(strm, yyAction8, yyNO_MATCH))
...
fun yyQ90 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction11(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx30
              then yyQ90(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
            else if inp < 0wx30
              then yyAction11(strm, yyNO_MATCH)
            else if inp <= 0wx39
              then yyQ90(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
...
fun yyQ89 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction11(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx45
              then yyQ91(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
            else if inp < 0wx45
              then if inp = 0wx30
                  then yyQ90(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
                else if inp < 0wx30
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp <= 0wx40
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ93(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp = 0wx61
