      ...
      in
        (case (lex(strm))
         of (Tok.SSTRING(_), _, strm') => expr_PROD_9(strm)
          ...
          | (Tok.TUPLE(_), _, strm') =>
              tryProds(strm, [expr_PROD_4, expr_PROD_8])
          | (Tok.STUPLE(_), _, strm') =>
              tryProds(strm, [expr_PROD_8, expr_PROD_9])
